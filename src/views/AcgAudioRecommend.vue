...
function getModuleIcon(moduleId?: string | number): string | null {
  if (moduleId == null) return null
  return iconMap[moduleId] || null
}
...
function goMore(module: AudioModule) {
...
<style scoped>
.acg-audio-recommend-wrapper {
  background: #f8f8f8;
  min-height: calc(100vh - 37.3vw - 16vw); /* 原140+60px ≈ 200px */
}
.content-container {
  max-width: 200vw; /* 根据实际调整，如不需要限制可去掉 */
  margin: 0 auto;
}
.recommend-module {
  margin-bottom: 0;
